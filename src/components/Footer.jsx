                        ...
                        <div className="-mx-4 flex flex-wrap justify-between">
                            <div className="px-4 my-4 w-full xl:w-1/5">
                                ...
                                <p className="text-justify">
                                    In the last 22 years, Happy Tour has completed a significant number of tours in all over
                                    the world. Around more than hundred tours both casual and
                                    family tours are now ongoing in Cox's Bazar and other areas of Chittagong.
                                </p>
                            </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="-mx-4 flex flex-wrap justify-between">
                            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                Copyright © 2020
                                - {moment().format('YYYY') }
                                 Happy Tour. All Rights Reserved.
                            </div>
                            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                Explore the world with "Happy Tour"
                            </div>
                        </div>
                    </div>
                </div>
